          ...
          children: [
            ...
            LayoutBuilder(
              builder: (context, constraints) {
                ...
                final horizontalPadding = (width * 0.08).clamp(16.0, 32.0);
                final topPadding = (height * 0.12).clamp(80.0, 120.0);
                return SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: (height * 0.03).clamp(20.0, 40.0)),
                      ...
                      _buildSignUpButton(),
                      SizedBox(height: (height * 0.05).clamp(24.0, 48.0)),
                    ],
                  ),
                ),
              );
