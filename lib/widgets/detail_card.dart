...
class DetailCard extends StatelessWidget {
  ...
  final VoidCallback? onAddPollutionConcern;
    ...
    return Container(
      ...
      child: Table(
        ...
        children: [
          ...
          _buildTableRow("Dw: Weather", score.dw, hasWeather),
        ],
      ),
    );
  }

  TableRow _buildTableRow(String label, double value, bool isValid) {
    return TableRow(
      children: [
        Padding(
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          title: const Row(
            children: [
              Icon(Icons.directions, color: _kMainTeal, size: 28),
              SizedBox(width: 12),
              Text(
                "Start Route?",
                style: TextStyle(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Icon(Icons.route, color: _kMainTeal, size: 24),
                    ...
                    Container(
                      ...
                      child: Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Icon(Icons.analytics, color: _kMainTeal, size: 24),
                          const SizedBox(width: 12),
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
